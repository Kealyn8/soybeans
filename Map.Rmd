...
zip_url <- "https://github.com/Kealyn8/soybeans/blob/main/va_shp.zip"
...
unzipped_files <- list.files(unzip_dir)
print(unzipped_files)

# Path to the shapefile (assuming it's named 'va_count.shp')
shapefile_path <- file.path(unzip_dir, "va_count.shp")

# Read the shapefile using st_read
count <- st_read(shapefile_path)
```
